        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('account.create') }}" class="btn btn-primary"><i class="fa fa-user-plus"></i> Add Account</a>
                                ...
                                @else
                                    @foreach($account as $key => $acc)
                                        <tr>
                                            ...
                                            <td>{{ $acc->email }}</td>
                                            <td>
                                                <a href="{{ route('account.edit', $acc->id ) }}" class="btn btn-sm btn-info">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
